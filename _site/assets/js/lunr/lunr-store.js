var store = [{
        ...
        "title": "홈페이지 제작 의뢰",
        "excerpt":"홈페이지 제작 의뢰를 받다 💯 wecode를 수료하고, 첫 직장에 채용합격을 받고 들어가기에 앞서 2주간의 휴식을 받았다. 그동안 못봤던 지인도 보고 열심히 놀러다니고 있었는데 지인으로 부터 회사소개 홈페이지를 제작 의뢰받았다. 결론 부터 말하자면 일주일간 열심히 홈페이지를 만들었고 의뢰인에게 \"이정도면 좋다. 회사 홈페이지로 써도 될거같다.\"라는 말을 들었으나 우선 디자인이 별로여서 일까? 내마음에...","categories": [],
        "tags": [],
        "url": "/interview-11/",
        "teaser": null
      }]
